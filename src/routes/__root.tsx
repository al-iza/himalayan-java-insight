...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Himalayan Java | Sales & Outlet Analytics" },
      {
        name: "description",
        content:
          "Management dashboard for Himalayan Java sales, product and outlet performance.",
      },
      { name: "author", content: "Himalayan Java" },
      { property: "og:title", content: "Himalayan Java | Sales & Outlet Analytics" },
      {
